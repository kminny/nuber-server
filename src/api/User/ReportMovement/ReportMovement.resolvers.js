...
var cleanNullArgs_1 = __importDefault(require("../../../utils/cleanNullArgs"));
var resolvers = {
    Mutation: {
        ReportMovement: privateResolver_1.default(function (_, args, _a) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            user = req.user;
                            notNull = cleanNullArgs_1.default(args);
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 4, , 5]);
